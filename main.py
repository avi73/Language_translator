...
# Main heading
lab_title = Label(root, text="LANGUAGE TRANSLATOR", font=("Arial", 25, "bold"), fg="#4B0082", bg='#F0F8FF')
lab_title.place(x=100, y=30, height=50, width=400)

# Label for source text box
lab_src = Label(root, text="ENTER YOUR TEXT", font=("Arial", 14, "bold"), fg="black", bg='#F0F8FF')
lab_src.place(x=50, y=100, height=30, width=150)
...
comb_sor.place(x=50, y=320, height=40, width=150)
...
comb_dest.place(x=360, y=320, height=40, width=150)
...
lab_dest.place(x=50, y=380, height=30, width=200)
